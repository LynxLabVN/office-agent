...
from hermes_cli.marketing_api import router as _marketing_router
from hermes_cli.hr_api import router as _hr_router
from hermes_cli.audit_api import router as _audit_router

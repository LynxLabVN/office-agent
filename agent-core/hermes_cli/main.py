...
from hermes_cli.marketing import build_marketing_parser, cmd_marketing
from hermes_cli.hr import build_hr_parser, cmd_hr
...
def main():
    ...
    # =========================================================================
    # marketing command — LynxLabVN video pipeline
    # =========================================================================
    marketing_parser = build_marketing_parser(subparsers)
    marketing_parser.set_defaults(func=cmd_marketing)

    # =========================================================================
    # hr command — LynxLabVN recruitment workflow
    # =========================================================================
    hr_parser = build_hr_parser(subparsers)
    hr_parser.set_defaults(func=cmd_hr)
